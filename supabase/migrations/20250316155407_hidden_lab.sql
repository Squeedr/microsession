/*
  ...
  1. Tables
    ...
    - workspaces: Manage different workspace types
    - workspace_members: Track workspace membership
    - resources: Manage workspace resources
    - spaces: Handle physical/virtual spaces
    - experts: Store expert profiles
    - sessions: Track scheduled sessions
